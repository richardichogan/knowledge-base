...
export const env = {
  ...
  // Separate Azure AI Foundry/OpenAI route for reasoning-model personas.
  // In production this is the deployed gpt-5.4 slot.
  // Optional: if unset, reasoning personas silently fall back to the default
  // model route rather than failing the request.
